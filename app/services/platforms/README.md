...
3. **The `Platform` class** must implement:
   ...
   class Platform:
       ...
       inquiry_agent_prompt = "..."              # system prompt for LLM inquiry fallback
       messaging_agent_prompt = "..."            # system prompt for LLM messaging agent
       ...
       def send_platform_reply(self, page: Page, conversation_url: str, message: str) -> bool: ...
   ```
